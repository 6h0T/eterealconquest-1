...
export function DownloadModal({ isOpen, onClose, lang }: DownloadModalProps) {
  ...
  const translations = {
    es: {
      ...
      version: "Versión Beta 1.0.0",
      lastUpdate: "Última actualización: 07/06/2025",
      minimum: "Mínimo",
    ...
    en: {
      ...
      lastUpdate: "Last update: 07/06/2025",
      minimum: "Minimum",
    ...
    pt: {
      ...
      version: "Versão Beta 1.0.0",
      lastUpdate: "Última atualização: 07/06/2025",
      minimum: "Mínimo",
      recommended: "Recomendado",
      os: "OS",
      cpu: "CPU",
                      ...
                      <CardContent className="p-6 flex flex-col flex-grow justify-between">
                        ...
                        <div className="mt-auto">
                          ...
                          <div className="grid grid-cols-3 gap-3 mb-4">
                            <a
                              href="https://www.mediafire.com/file/a7kgfeilexwfc31/Etereal_Mu_Beta.rar/file"
                            ...
                            <a
                              href="https://mega.nz/file/TZBVCRzJ#u9Viwe1k2s8tzTUohTA7MgYNgus05KN92bqc_yUIDJ0"
                            ...
                            <a
                              href="https://drive.google.com/file/d/1x9QuFac95tuDf6dSL3BkMuAAq_K-3wdm/view"
